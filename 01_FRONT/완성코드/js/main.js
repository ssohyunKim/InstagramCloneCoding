...
function resizeFunc() {
    ...
    if (pageYOffset >= 10) {
        ...
        let calcWidth = (window.innerWidth * 0.5) + 167; //167이라는 편차를 더해서 사이즈 조정했다. 
...
if (delegation) { //pure자바스크립트는 jquery와 다르게 없을때 실행안되서 조건 넣어준것. delegation변수는 content-box=>피드를 의미
